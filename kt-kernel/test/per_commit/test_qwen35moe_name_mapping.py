...
from kt_kernel.sglang_loader_hook import (  # noqa: E402
...
def test_loader_hook_dispatches_non_qwen_to_original():
    ...
    try:
        ...
        with pytest.raises(RuntimeError):
            GGUFModelLoader(None)._get_gguf_weights_map(model_config)
    finally:
        uninstall_gguf_qwen35moe()
...
def test_loader_hook_dispatches_qwen35moe_to_custom():
    ...
    try:
        ...
        model_config = type("MC", (), {"hf_config": cfg})()
        m = GGUFModelLoader(None)._get_gguf_weights_map(model_config)
